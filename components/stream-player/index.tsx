...
export const StreamPlayer = ({
    ...
    return (
        <>
           ...
           >
            <div className="space-y-4 col-span-1 lg:col-span-2 xl:col-span-2 2xl:col-span-5  hidden-scrollbar pb-10">
                <Video 
...
export const StreamPlayerSkeleton = () => {
    return (
        <div className="grid grid-cols-1 lg:gap-y-0 lg:grid-cols-3 xl:grid-cols-3
